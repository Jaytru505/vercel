...
export type GetConfigurationResponseBodyIntegrationsResponseUpgraded = ClosedEnum<
...
export type GetConfigurationResponseBodyIntegrationsResponseDisabledReason = ClosedEnum<
 ...
 * Defines the installation type. - 'external' integrations are installed via the existing integrations flow - 'marketplace' integrations are natively installed: - when accepting the TOS of a partner during the store creation process - if undefined, assume 'external'
 */
export type GetConfigurationResponseBodyIntegrationsResponseInstallationType = ClosedEnum<
...
export type GetConfigurationResponseBody3 = {
     ...
     */
    scopes: Array<string>;
    scopesQueue?: Array<GetConfigurationResponseBodyIntegrationsResponseScopesQueue> | undefined;
    /**
...
/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseAdded$inboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseAdded
> = z.nativeEnum(GetConfigurationResponseBodyIntegrationsResponseAdded);

/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseAdded$outboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseAdded
...
/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseUpgraded$inboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseUpgraded
> = z.nativeEnum(GetConfigurationResponseBodyIntegrationsResponseUpgraded);

/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseUpgraded$outboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseUpgraded
...
export const GetConfigurationResponseBodyIntegrationsResponseScopes$inboundSchema: z.ZodType<
    ...
    unknown
> = z.object({
    added: z.array(GetConfigurationResponseBodyIntegrationsResponseAdded$inboundSchema),
    upgraded: z.array(GetConfigurationResponseBodyIntegrationsResponseUpgraded$inboundSchema),
});
...
export const GetConfigurationResponseBodyIntegrationsResponseScopes$outboundSchema: z.ZodType<
    ...
    GetConfigurationResponseBodyIntegrationsResponseScopes
> = z.object({
    added: z.array(GetConfigurationResponseBodyIntegrationsResponseAdded$outboundSchema),
    upgraded: z.array(GetConfigurationResponseBodyIntegrationsResponseUpgraded$outboundSchema),
});
...
/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseScopesQueue$inboundSchema: z.ZodType<
...
/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseScopesQueue$outboundSchema: z.ZodType<
...
export namespace GetConfigurationResponseBodyIntegrationsResponseScopesQueue$ {
    ...
    export type Outbound = GetConfigurationResponseBodyIntegrationsResponseScopesQueue$Outbound;
}

/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseDisabledReason$inboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseDisabledReason
> = z.nativeEnum(GetConfigurationResponseBodyIntegrationsResponseDisabledReason);

/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseDisabledReason$outboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseDisabledReason
...
/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseInstallationType$inboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseInstallationType
> = z.nativeEnum(GetConfigurationResponseBodyIntegrationsResponseInstallationType);

/** @internal */
export const GetConfigurationResponseBodyIntegrationsResponseInstallationType$outboundSchema: z.ZodNativeEnum<
    typeof GetConfigurationResponseBodyIntegrationsResponseInstallationType
...
> = z.object({
    ...
    scopesQueue: z
        .array(
            z.lazy(() => GetConfigurationResponseBodyIntegrationsResponseScopesQueue$inboundSchema)
        )
        .optional(),
    disabledAt: z.number().optional(),
    deletedAt: z.nullable(z.number()).optional(),
    disabledReason:
        GetConfigurationResponseBodyIntegrationsResponseDisabledReason$inboundSchema.optional(),
    northstarMigratedAt: z.number().optional(),
    installationType:
        GetConfigurationResponseBodyIntegrationsResponseInstallationType$inboundSchema.optional(),
...
export type GetConfigurationResponseBody3$Outbound = {
    ...
    scopes: Array<string>;
    scopesQueue?:
        | Array<GetConfigurationResponseBodyIntegrationsResponseScopesQueue$Outbound>
        | undefined;
    disabledAt?: number | undefined;
    deletedAt?: number | null | undefined;
...
> = z.object({
    ...
    scopesQueue: z
        .array(
            z.lazy(() => GetConfigurationResponseBodyIntegrationsResponseScopesQueue$outboundSchema)
        )
        .optional(),
    disabledAt: z.number().optional(),
    deletedAt: z.nullable(z.number()).optional(),
    disabledReason:
        GetConfigurationResponseBodyIntegrationsResponseDisabledReason$outboundSchema.optional(),
    northstarMigratedAt: z.number().optional(),
    installationType:
        GetConfigurationResponseBodyIntegrationsResponseInstallationType$outboundSchema.optional(),
    canConfigureOpenTelemetry: z.boolean().optional(),
});
