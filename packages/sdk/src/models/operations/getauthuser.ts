...
/** @internal */
export const User$inboundSchema: z.ZodType<User, z.ZodTypeDef, unknown> = z.union([
    components.AuthUserLimited$inboundSchema,
    components.AuthUser$inboundSchema,
]);

/** @internal */
export type User$Outbound = components.AuthUserLimited$Outbound | components.AuthUser$Outbound;

/** @internal */
export const User$outboundSchema: z.ZodType<User$Outbound, z.ZodTypeDef, User> = z.union([
...
export const GetAuthUserResponseBody$inboundSchema: z.ZodType<
    ...
    unknown
> = z.object({
    user: z.union([components.AuthUserLimited$inboundSchema, components.AuthUser$inboundSchema]),
});
...
export const GetAuthUserResponseBody$outboundSchema: z.ZodType<
    ...
    GetAuthUserResponseBody
> = z.object({
    user: z.union([components.AuthUserLimited$outboundSchema, components.AuthUser$outboundSchema]),
});
