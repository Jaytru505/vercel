...
/** @internal */
export const Aliases$inboundSchema: z.ZodType<Aliases, z.ZodTypeDef, unknown> = z.object({
    alias: z.string(),
    created: z
        .string()
...
/** @internal */
export const Aliases$outboundSchema: z.ZodType<Aliases$Outbound, z.ZodTypeDef, Aliases> = z.object({
    alias: z.string(),
