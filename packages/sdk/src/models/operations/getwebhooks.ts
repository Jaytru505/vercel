...
export const ProjectsMetadata$inboundSchema: z.ZodType<ProjectsMetadata, z.ZodTypeDef, unknown> =
    z.object({
        id: z.string(),
        name: z.string(),
        framework: z.nullable(GetWebhooksResponseBodyFramework$inboundSchema).optional(),
...
> = z.object({
    id: z.string(),
    name: z.string(),
    framework: z.nullable(GetWebhooksResponseBodyFramework$outboundSchema).optional(),
    latestDeployment: z.string().optional(),
});
