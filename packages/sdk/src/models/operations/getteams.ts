...
/** @internal */
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z.union([
    components.Team$inboundSchema,
    components.TeamLimited$inboundSchema,
]);

/** @internal */
export type Teams$Outbound = components.Team$Outbound | components.TeamLimited$Outbound;

/** @internal */
export const Teams$outboundSchema: z.ZodType<Teams$Outbound, z.ZodTypeDef, Teams> = z.union([
...
export const GetTeamsResponseBody$inboundSchema: z.ZodType<
    ...
    unknown
> = z.object({
    teams: z.array(z.union([components.Team$inboundSchema, components.TeamLimited$inboundSchema])),
